  ...
  return (
    ...
    <div>
      ...
      <main className="bg-white h-screen flex flex-col items-center">
        <head className="h-screen flex flex-col items-center justify-center py-48">
        ...
        <div className="flex md:flex-row flex-col justify-between py-16 max-w-6xl w-full gap-10">
          ...
          <a>
            <div className="overflow-hidden rounded-2xl">
              ...
              <Image src="/image/image_02.png" width={555} height={557} className=" h-auto max-w-full hover:scale-125 transition-all duration-500 cursor-pointer"/>
                  
              <Image src="/image/image_01.png" width={555} height={557} className=" h-auto max-w-full hover:scale-125 transition-all duration-500 cursor-pointer"/>
                    
              <Image src="/image/image_03.png" width={555} height={557} className=" h-auto max-w-full hover:scale-125 transition-all duration-500 cursor-pointer"/>
